...
export default function Avatar_acc_place({
  ...
  // Move validation inside useEffect - this runs AFTER component mounts
  useEffect(() => {
    // Validate audio path when component mounts
    const audioPath = "/panel_click.mp3";
  ...
  // Validate paths (log errors but don't block rendering)
  ...
  if (typeof validateAssetPath === "function") {
    if (!validateAssetPath(texturePath)) {
      console.error("Blocked unsafe texture path:", texturePath);
    }
